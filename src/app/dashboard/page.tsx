        ...
        <div className="rounded-xl bg-white shadow-sm">
          ...
          <div className="flex flex-col gap-2 p-6">
            ...
            <Link
              ...
              className="flex items-center justify-between rounded-lg border border-transparent bg-yellow-50 p-3 text-yellow-700 transition-colors hover:bg-yellow-100"
            >
